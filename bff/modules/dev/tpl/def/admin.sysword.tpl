...
<tr>
	<td class="row1 field-title" style="width:40px;">Слово:</td>
	<td class="row2">
        <input type="text" id="word" size="30" value="" />
        <span class="clr-error" id="word-sys" style="display:none;"> - системное</span>
        <span class="clr-success" id="word-ok" style="display:none;"> - можно использовать</span>
    </td>
</tr>
<tr class="footer">
	<td colspan="2" class="row1">
        <input type="button"  class="button submit" value="Проверить!" onclick="devCheckIsSystemWord();" />
	</td>
</tr>
</table>
</form>
...
$(document).ready(function(){ $('#word').focus(); }); 
