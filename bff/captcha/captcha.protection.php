...
class CCaptchaProtection {
	...
	function generateMath( $bOnlyPlusAction = true ) {
	...
	function valid($actualResult, $userEntered) 
    {
		if ($userEntered == '')
            return false;
	...
	function generate_hash($inputstring, $day) 
    {
