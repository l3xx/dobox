...
<?php if ($this->_tpl_vars['aData']['cats']): ?>
    <?php echo $this->_tpl_vars['aData']['cats_html']; ?>

<?php else: ?>
    <tr class="norecords">
        <td colspan="5">
            нет категорий (<a href="index.php?s=<?php echo $this->_tpl_vars['class']; ?>
&ev=categories_add">добавить</a>)
        </td>
    </tr>
<?php endif; ?>        
</table>
