            ...
            <div class="leftBlock">
                <div class="topLinks {if $userLogined} logined{/if}" id="userMenu">
                    {if $userLogined}
                        ...
                        {if $config.userMenuCurrent == 3}<span class="cont left activeCount"><span class="left"><b class="ads">Мой счет</b> (<b class="f14">{$config.user_balance}</b> <span class="f10Up">руб</span>)</span><span class="rightCor">&nbsp;</span></span>
                        {else}<span class="cont left"><span class="left"><a href="/bill" title="Мой счет" class="count"  style="color:grey;">Мой счет</a> (<b class="f14">{$config.user_balance}</b> <span class="f10Up">руб</span>)</span><span class="rightCor">&nbsp;</span></span>{/if}
