  ...
  <div class="container">
    ...
    <div class="content">
        ...
        <div class="item blockOb">
            ...
            <div class="price"><span class="date"><?= tpl::date_format3($i['publicated_from'], 'd.m.Y') ?></span><?php if($i['cat_prices']): ?><b class="f18 orange"><?= $i['price']; ?></b> <span class="f11Up orange">$</span><br/><?= ($i['price_torg'] ? 'торг' : '').($i['price_bart'] ? ($i['price_torg'] ? ', ': '').'бартер' : '' ); ?><? endif; ?></div>
            <div class="clear"></div>
        </div>
        <? } ?>       
    </div>
