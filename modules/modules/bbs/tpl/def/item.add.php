    ...
    <div class="add-step-content">
        ...
        <div class="padBlock">
            ...
            <div class="add-ad-adtext padTop">
                ...
                <div class="add-ad-field">
                    <textarea style="width:652px; height:80px;" id="add-step-infotext" class="inputText2 adtxt" name="info"></textarea>
                </div>
            </div>
        ...
        <div class="padBlock"> 
            ...
            <div class="clear"></div>
                ...
                <div class="add-ad-skype padTop">
                    ...
                    <div class="add-ad-field"><input type="text" name="contacts[skype]" value="<?= $contacts['skype']; ?>" class="inputText2" /></div>
                </div>
