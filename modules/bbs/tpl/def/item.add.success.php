...
<div class="padBlock noBorder">
  ...
  <div class="textPad">
    <div class="advBlock">
      ...
      <div class="desc">
        <?php if($cat_type>0): ?><b class="upper"><?= $cat_type_title; ?>:</b> <?php endif; ?>
        <?php if($cat_subtype>0): ?><b class="upper"><?= $cat_subtype_title; ?>:</b> <?php endif; ?><?= nl2br($title); ?>
        <div class="ad-text"><?= nl2br($descr); ?></div>
