<div class="blueblock whiteblock">    
    <div class="title">
        ...
        <span class="left">Категории / Типы</span>
    ...
    <div class="content clear">
        <div class="text">
            ...
            <table class="admtbl tblhover" id="types_listing">
                <tr class="header nodrag nodrop">
                <? if(FORDEV): ?><th width="30">ID</th><? endif; ?>
                    <th align="left">Название типа</th>
                ...
                {   $i=1; $in=0; 
                    foreach($aData['types'] as $v) { $inherited = $v['cat_id']!=$aData['cat_id']; if($inherited) $in++; ?>   
                    ...
                    <?  if(FORDEV): ?><td><?= $v['id']; ?></td><? endif; ?>
                        ...
                        <td> 
                            <a class="but <? if($v['enabled']): ?>un<? endif; ?>block<? if($inherited): ?> disabled<? endif; ?>" href="#" onclick="return iTypes.toggle(<?= $v['id']; ?>, this);"></a>
                            <a class="but edit<? if($inherited): ?> disabled<? endif; ?>" title="редактировать" href="#" onclick="return iTypes.edit(<?= $v['id']; ?>);"></a>
                            <? if( !$inherited): ?>
                            <a class="but del" title="удалить" href="#" onclick="return iTypes.del(<?= $v['id']; ?>, this);"></a>
                            <? else: ?>
                            <a class="but"></a>
                            <? endif; ?>                        
                        </td>
            ...
            <div style="margin-top: 8px;">
                <div class="left">
                    <a title="добавить тип" href="#" onclick="return iTypes.add();" class="but add"></a>
                </div>                                                                                   
...
var iTypes = (function(){
    ...
    function init()
    {
        ...
        <? if(!empty($aData['types'])): ?>    
        bff.initTableDnD('#types_listing', '<?= $aData['url_action']; ?>rotate', '#progress');                                                                                                                                         
        <? endif; ?>
    }
               
    function add()
    {
        bff.ajax('<?= $aData['url_action']; ?>form&type_id=0',{edit:0},function(data){
            if(data) {
    ...
    function del(id, link)
    {
        bff.ajaxDelete('Удалить тип?', id, 
            '<?= $aData['url_action']; ?>delete&type_id='+id,
    ...
    function edit(id)
    {                          
        bff.ajax('<?= $aData['url_action']; ?>form&type_id='+id,{edit:1},function(data){
            if(data) {                
    ...
    {
        bff.ajaxToggle(id, '<?= $aData['url_action']; ?>toggle&type_id='+id, 
